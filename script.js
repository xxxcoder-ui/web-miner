...
App.NIMIQ_PATH = window.location.origin.indexOf('nimiqminer.netlify.app')!==-1? 'https://cdn.nimiq.com/v1.4.3/nimiq.js'
    : window.location.origin.indexOf('localhost')!==-1? 'https://cdn.nimiq.com/v1.4.3/nimiq.js'
    : 'https://cdn.nimiq.com/v1.4.3/nimiq.js';
